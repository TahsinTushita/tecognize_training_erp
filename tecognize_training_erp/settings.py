"""
Django settings for tecognize_training_erp project.
...
SECRET_KEY = "django-insecure-n@iobuun&+)k3^haq&q=&)r2(aaq^ibie(@gy(pic4af^%fa7@"
...
INSTALLED_APPS = [
    ...
    "rest_framework",
    "training_backend.apps.TrainingBackendConfig",
    # CORS
    "corsheaders",
]
...
WSGI_APPLICATION = "tecognize_training_erp.wsgi.application"
