    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cust_phone', models.CharField(max_length=22, unique=True)),
                ('cust_email', models.CharField(max_length=255)),
                ('cust_address', models.CharField(max_length=200)),
                ('cust_organization', models.CharField(max_length=200)),
                ('cust_designation', models.CharField(max_length=150)),
