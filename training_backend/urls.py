...
urlpatterns = [
    ...
    url(r"^backend/api/retail-customers$", views.retail_customer_list),
    url(
        r"^backend/api/retail-customers/(?P<pk>[a-zA-Z0-9_]+)$",
        views.retail_customer_detail,
    ),
    url(r"^backend/api/retail-fee-update$", views.retail_fee_update),
    url(r"^backend/api/retail-customers-count$", views.retail_customer_count),
