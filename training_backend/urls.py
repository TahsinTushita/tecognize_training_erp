...
urlpatterns = [
    ...
    url(r"^api/batches-by-course$", views.batch_by_course),
    url(r"^api/batch-list$", views.batch_list_table),
    url(r"^api/batches/(?P<pk>[a-zA-Z0-9_]+)$", views.batch_detail),
    url(r"^api/batch-admission/(?P<pk>[a-zA-Z0-9_]+)$", views.batch_admission),
